...
//        text.textColor = .black
    ...
    private func setupConstraint() {
        NSLayoutConstraint.activate([
            ...
            buttonShowStatus.topAnchor.constraint(equalTo: self.userPhoto.bottomAnchor, constant: 31),
            ...
            userStatus.bottomAnchor.constraint(equalTo: self.buttonShowStatus.topAnchor, constant: -59),
